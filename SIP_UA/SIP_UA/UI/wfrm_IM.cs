    ...
    public class wfrm_IM : Form
    {
        ...
        private void SendActiveText()
        {
            try{
                ...
                SIP_Request request = m_pCommunicator.SIP_UA.Stack.CreateRequest(SIP_Methods.MESSAGE,m_FromURI,new SIP_t_NameAddress(m_pAccount.DisplayName,AbsoluteUri.Parse("sip:" + m_pAccount.AOR)));
                ...
                SIP_RequestSender sender = m_pCommunicator.SIP_UA.Stack.CreateRequestSender(request);
