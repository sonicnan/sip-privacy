...
namespace SIP_Proxy_demo
{
    ...
    public class wfrm_SipRegistration : Form
    {
        ...
        public wfrm_SipRegistration(SIP_Proxy sipProxy)
        {
        ...
        public wfrm_SipRegistration(SIP_Proxy sipProxy, SIP_Registration registration)
        {
            m_pSipProxy = sipProxy;
        ...
        private void LoadContacts()
        {
            ...
            foreach (SIP_RegistrationBinding binding in m_pRegistration.Bindings)
            {
                ListViewItem it = new ListViewItem(binding.ContactURI.Value);
                it.SubItems.Add(binding.LastUpdate.ToString());
                it.SubItems.Add(binding.QValue.ToString("f2"));
                it.Tag = false;
                m_pContacts.Items.Add(it);
            }
        }
