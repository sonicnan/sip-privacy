...
{
    /// <summary>
    /// Add/edit gateway window.
    /// </summary>
    public class wfrm_Gateway : Form
    {
        ...
        public wfrm_Gateway(string uriScheme,string transport,string host,int port,string realm,string userName,string password)
        {
            InitUI();
