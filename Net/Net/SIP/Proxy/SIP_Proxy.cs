...
namespace LumiSoft.Net.SIP.Proxy
{
    ...
    public class SIP_Proxy : IDisposable
    {
        ...
        public SIP_Stack Stack
        {
            get{ 
                if(m_IsDisposed){
                    throw new ObjectDisposedException("Stack"+this.GetType().Name);
                }
        ...
        public SIP_ProxyMode ProxyMode
        {
            get{ 
                if(m_IsDisposed){
                    throw new ObjectDisposedException("ProxyMode" + this.GetType().Name);
                }
        ...
        public SIP_ForkingMode ForkingMode
        {
            get{ 
                if(m_IsDisposed){
                    throw new ObjectDisposedException("ForkingMode" + this.GetType().Name);
                }
        ...
        public SIP_Registrar Registrar
        {
            get{ 
                if(m_IsDisposed){
                    throw new ObjectDisposedException("Registrar"+this.GetType().Name);
                }
        ...
        public SIP_B2BUA B2BUA
        {
            get{ 
                if(m_IsDisposed){
                    throw new ObjectDisposedException("B2BUA"+this.GetType().Name);
                }
        ...
        public List<SIP_ProxyHandler> Handlers
        {
            get{ 
                if(m_IsDisposed){
                    throw new ObjectDisposedException("Handlers"+this.GetType().Name);
                }
